...
/***/ (function(module, exports, __webpack_require__) {
	...
	var remainEvents = __webpack_require__(12
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    ...
	    production: 'https://octater-dirt-napstr-api.herokuapp.com'
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var signUpFailure = function signUpFailure(error) {
	  ...
	  $('#signUpError').show().html('Something\'s wrong with your signup. Please try again.');
	  setTimeout(function () {
	...
	var signInFailure = function signInFailure(error) {
	  $('.form-control').val('');
	  $('#signInError').show().html('Something\'s wrong with your login. Please try again.');
	  setTimeout(function () {
	...
	var changePasswordFailure = function changePasswordFailure(error) {
	  $('.form-control').val('');
	  $('#ChangePasswordError').show().html('Check your password and please try again.');
	  setTimeout(function () {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onCreateRemain = function onCreateRemain(event) {
	  event.preventDefault();
	  var data = getFormFields(this);

	  api.createRemain(data).then(function (data) {
	...
	var onUpdateRemain = function onUpdateRemain(event) {
	  event.preventDefault();
	  var data = getFormFields(this
	  // console.log('>>>>>>>>onUpdateRemain: data = ', data)
	  );api.updateRemain(data).then(function (data) {
	...
	var populateViewForm = function populateViewForm(id) {
	  var remain = findRemainById(id
	...
	var findRemainById = function findRemainById(idToCompare) {
	  var result = void 0;
	  var i = void 0;
	  for (i in store.remains) {
	    // console.log('in findRemainById and i is: ', i)
	    var myObj = store.remains[i];
	...
	var onShowViewRemain = function onShowViewRemain() {
	  $('#viewRemain').modal('show');
	};

	var onShowUpdateRemain = function onShowUpdateRemain() {
	  $('#updateRemain').modal('show');
	};

	var onGetRemains = function onGetRemains(event) {
	  api.getRemains().then(ui.getRemainsSuccess).catch(ui.getRemainsFailure);
	};
	...
	var deleteItem = function deleteItem() {
	  ...
	  );api.deleteRemain(id).done(ui.deleteRemainSuccess).fail(ui.deleteRemainFailure);
	  onGetRemains();
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var createRemain = function createRemain(data) {
	...
	var updateRemain = function updateRemain(data) {
	...
	var deleteRemain = function deleteRemain(id) {
	...
	module.exports = {
	  createRemain: createRemain,
	  getRemains: getRemains,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(10);
	var showRemainsTemplate = __webpack_require__(15);
	var api = __webpack_require__(13);

	var getRemains = function getRemains(event) {
	  api.getRemains().then(getRemainsSuccess).catch(getRemainsFailure);
	};

	var clearRemainModal = function clearRemainModal() {
	  $('#title').val('');
	};

	var createRemainSuccess = function createRemainSuccess(data) {
	  // console.log('createRemainSuccess')
	  $('.list-group').empty();
	  getRemains();
	};

	var createRemainFailure = function createRemainFailure(error) {
	...
	var updateRemainSuccess = function updateRemainSuccess(data) {
	  // store.remain = data.remain
	  // console.log('updateRemainSuccess')
	  getRemains();
	};

	var updateRemainFailure = function updateRemainFailure(error) {
	...
	var getRemainsSuccess = function getRemainsSuccess(data) {
	  ...
	  ();if (data.remains[0] !== undefined) {
	    ...
	    var showRemainsHtml = showRemainsTemplate({ remains: data.remains }
	...
	var getRemainsFailure = function getRemainsFailure(error) {
	  console.error(error);
	};
	...
	var deleteRemainSuccess = function deleteRemainSuccess(data) {
	  // store.remain = data.remain
	...
	var deleteRemainFailure = function deleteRemainFailure(error) {
	  // console.log('deleteRemainFailure, error = ', error)
	  console.error(error);
	};

	module.exports = {
	  clearRemainModal: clearRemainModal,
	  createRemainSuccess: createRemainSuccess,
	  createRemainFailure: createRemainFailure,
	  updateRemainSuccess: updateRemainSuccess,
	  updateRemainFailure: updateRemainFailure,
	  getRemainsSuccess: getRemainsSuccess,
	  getRemainsFailure: getRemainsFailure,
	  // getDynamicRemainsSuccess,
	  // getDynamicRemainsFailure,
	  // getOneDynamicRemainSuccess,
	  // getOneDynamicRemainFailure,
	  deleteRemainSuccess: deleteRemainSuccess,
	  deleteRemainFailure: deleteRemainFailure,
	  getRemains: getRemains
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "        <tr data-id=\""
	    ...
	    + "\">\n          <td>"
	    + alias2(((helper = (helper = helpers["null"] || (depth0 != null ? depth0["null"] : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"null","hash":{},"data":data,"blockParams":blockParams}) : helper)))
	    + "</td>\n          <td>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.given_name : stack1), depth0))
	    + " "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.sur_name : stack1), depth0))
	    + "</td>\n          <td>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.entombment : stack1), depth0))
	    + "</td>\n          <!-- <td>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.location : stack1), depth0))
	    + "</td> -->\n          <td>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.dod : stack1), depth0))
	    + "</td>\n\n          <td class=\"hideMe\">"
	    ...
	    + "</td> -->\n          <!-- <td class=\"glyphicon\"><button type=\"button\" class=\"remove-remain btn btn-default glyphicon\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\"><span class=\"glyphicon glyphicon-remove\" aria-hidden=\"true\"></span></button></td> -->\n          <td class=\"glyphicon\"><button type=\"button\" class=\"remove-remain btn glyphicon\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\"><span class=\"glyphicon glyphicon-remove\" aria-hidden=\"true\"></span></button></td>\n          <td class=\"glyphicon\"><button type=\"button\" class=\"update-remain btn glyphicon\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\"><span class=\"glyphicon glyphicon-pencil\" aria-hidden=\"true\"></span></button></td>\n          <td class=\"glyphicon\"><button type=\"button\" id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"view-remain see-response btn glyphicon\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\"><span class=\"glyphicon glyphicon-eye-open\" aria-hidden=\"true\"></span></button></td>\n\n      </tr>\n    </tbody>\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "<table class=\"table\" id=\"remain-list-table\">\n  <BR />\n  <col style=\"width:20%\">\n  <col style=\"width:20%\">\n  <col style=\"width:20%\">\n  <col style=\"width:20%\">\n  <thead>\n    <tr>\n      <th></th>\n      <th>Name</th>\n      <th>Entombment</th>\n      <!-- <th>Location</th> -->\n      <th>Date of Death</th>\n      <!-- <th>Owner</th> -->\n    </tr>\n  </thead>\n\n    <tbody>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.remains : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "\n  </table>\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "26669c8aecf24b2318efa2bc17f8582a.jpg";
